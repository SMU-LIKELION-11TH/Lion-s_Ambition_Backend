...
urlpatterns = [
    ...
    path('manage', RequireLoginTemplateView.as_view(template_name='manage_view.html')),
    path('manage/order', RequireLoginTemplateView.as_view(template_name='ordermenu.html')),
    path('manage/menu', RequireLoginTemplateView.as_view(template_name='menu.html')),
    path('manage/sales', RequireLoginTemplateView.as_view(template_name='manage.html')),
    ...
    path('m/cart', TemplateView.as_view(template_name="mobile-view/cart.html")),
